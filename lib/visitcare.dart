...
class VisitCare extends StatefulWidget {
  _VisitCare createState() => _VisitCare();
}

class _VisitCare extends State<VisitCare> {
  ...
  void initState() {
    ...
    dummyData.add(DummyData("방문요양1", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 0,
        1, 1, 1, "assets/pic1.png"));
    dummyData.add(DummyData("방문요양2", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 40,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: bar = appBar(2, "방문요양", context),
      drawer: DrawerMenu(),
      body: Stack(
        children: <Widget>[
          Container(
