...
class Care extends StatefulWidget {
  _Care createState() => _Care();
}

class _Care extends State<Care> {
  ...
  void initState() {
    ...
    dummyData.add(DummyData("요양원1", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 0,
        1, 1, 1, "assets/pic1.png"));
    dummyData.add(DummyData("요양원2", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 40,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: bar = appBar(2, "요양원", context),
      drawer: DrawerMenu(),
      body: Stack(
        children: <Widget>[
          Container(
...
//                            child: Center(
//                              child: Text("기관찾기", style: TextStyle(
