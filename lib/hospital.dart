...
class _Hospital extends State<Hospital> {
  ...
  void initState() {
    ...
    dummyData.add(DummyData("요양병원1", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 0,
        1, 1, 1, "assets/pic1.png"));
    dummyData.add(DummyData("요양병원2", "경기도 수원시 장안구 하광교동 428", "031-232-2222", 40,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: bar = appBar(2, "요양병원", context),
      drawer: DrawerMenu(),
      body: Stack(
        children: <Widget>[
          Container(
